...
// import 'package:fitgoapp/login/home.dart';
import 'package:fitgoapp/login/signup.dart';
          ...
          Column(
            children: [
              CircleAvatar(
                ...
                radius: 85.0,
                child: CircleAvatar(
                  backgroundImage: AssetImage('assets/Yoga.webp'),
                  radius: 80.0,
                ),
              ),
                  ...
                  AuthenticationHelper()
                    ...
                    if (result == null) {
                      Navigator.pushReplacement(context,
                          MaterialPageRoute(builder: (context) => Dashboard(name:email ?? '',)));
                    } else {
